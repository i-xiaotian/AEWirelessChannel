...
public class ItemBlockWirelessOutputBus extends ItemBlockBaseWirelessBus {

    private final static String I18N_KEY_PREFIX = "tooltip.aewirelesschannel.tile_wireless_bus_output.info.";

    public ItemBlockWirelessOutputBus(Block block) {

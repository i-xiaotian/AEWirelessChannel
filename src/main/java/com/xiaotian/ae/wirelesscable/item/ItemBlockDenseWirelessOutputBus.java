...
public class ItemBlockDenseWirelessOutputBus extends ItemBlockBaseWirelessBus {

    private final static String I18N_KEY_PREFIX = "tooltip.aewirelesschannel.tile_dense_wireless_bus_output.info.";

    public ItemBlockDenseWirelessOutputBus(Block block) {
        super(block);
    }
